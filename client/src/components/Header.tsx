...
const UNICORN_ICON_SRC = "/images/site-assets/brand/unicorn-48-4x.png";
    ...
    <>
      <header className="pointer-events-none fixed inset-x-0 top-0 z-[70] h-0">
        <Link
          href={targetHref}
          aria-label={label}
          className={`pointer-events-auto fixed ${NAV_BUTTON_TOP} flex h-12 w-12 items-center justify-center overflow-hidden rounded-full border border-black/10 shadow-[0_1.1rem_2.8rem_rgba(0,0,0,0.22)] transition-[background-color,box-shadow,transform] duration-300 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-4`}
          style={{
