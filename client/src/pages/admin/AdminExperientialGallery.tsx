...
// --- Main Page Component ---
export default function AdminExperientialGallery() {
    ...
    const { data: galleryItems, isLoading: galleryLoading, refetch: refetchGallery } = trpc.experientialGallery.list.useQuery();

    // Mutations
    const createProjectMutation = trpc.projects.create.useMutation();

    // Check if add mutation exists, if often used
    const addMutation = trpc.experientialGallery.add.useMutation({
        onSuccess: () => {
    ...
    const removeMutation = trpc.experientialGallery.remove.useMutation({
        onSuccess: () => {
    ...
    const updateMetaMutation = trpc.experientialGallery.updateMetadata.useMutation();
    ...
    if (projectsLoading || galleryLoading) {
        return (
            <AdminLayout title="Experiential Gallery" description="Loading...">
    ...
    return (
        <AdminLayout
            title="Experiential Portfolio Gallery"
            description="Curate the SEO landing page gallery for Experiential Design. Add new images directly or select existing projects."
        >
