...
import { Copy, Palette, Paintbrush, ArrowRight, ArrowLeft, Archive, Sliders } from 'lucide-react';
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative h-[30vh] md:h-[35vh] overflow-hidden border-b border-border">
          <img 
            src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663337866878/MtnVhwckqruzlJNJ.webp"
            alt="Rosco Paint Calculator - Professional scenic paint mixing" 
            className="absolute inset-0 w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-background via-background/80 to-background/20" />
          
          <div className="relative container max-w-5xl h-full flex flex-col justify-end pb-8">
            <div className="flex items-center gap-2 mb-4">
              <Palette className="h-5 w-5 text-purple-500" />
              <span className="text-xs tracking-[0.3em] text-muted-foreground font-semibold uppercase">
                Rosco Paint Calculator
              </span>
            </div>
            <h1 className="text-4xl md:text-5xl font-serif mb-3">
              Professional Paint Mixing
            </h1>
            <p className="text-lg text-muted-foreground max-w-2xl">
              Advanced 5-step mixing engine for precise scenic color matching with Rosco Off-Broadway paints.
            </p>
          </div>
        </section>
        ...
        <section className="container max-w-5xl py-6 md:py-8">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
            <div className="flex-1">
              <h2 className="text-2xl font-semibold mb-2">Mix Your Color</h2>
              <p className="text-muted-foreground">Select a target color to generate a mixing recipe from Rosco paints.</p>
            </div>
                ...
                <div className="lg:col-span-8 space-y-6">
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-8 flex items-end justify-between">
                            ...
                            <Paintbrush className="w-16 h-16" style={{ color: colors.headerIcon }} />
                        </div>
                    </div>
