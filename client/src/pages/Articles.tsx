...
const ARTICLE_SITE_COLORS = {
  cream: {
    swatchColor: "#e9e1cf",
    swatchTextColor: "#20180f",
    swatchMutedColor: "rgba(32,24,15,0.72)",
    swatchChipBg: "rgba(255,111,0,0.2)",
  },
  orange: {
    swatchColor: "#ff6f00",
    swatchTextColor: "#20180f",
    swatchMutedColor: "rgba(32,24,15,0.72)",
    swatchChipBg: "rgba(32,24,15,0.12)",
  },
  blue: {
    swatchColor: "#1385f6",
    swatchTextColor: "#a8f4ff",
    swatchMutedColor: "rgba(5,47,139,0.78)",
    swatchChipBg: "rgba(5,47,139,0.16)",
  },
  green: {
    swatchColor: "#35ad62",
    swatchTextColor: "#003f1c",
    swatchMutedColor: "rgba(0,63,28,0.76)",
    swatchChipBg: "rgba(186,255,0,0.22)",
  },
  purple: {
    swatchColor: "#3f0050",
    swatchTextColor: "#ffe3ff",
    swatchMutedColor: "rgba(220,48,255,0.8)",
    swatchChipBg: "rgba(220,48,255,0.18)",
  },
};
...
const CATEGORY_STYLES: Record<string, CategoryStyle> = {
  "Design Process": {
    ...
    color: "text-[#dc30ff]",
    bg: "bg-[#dc30ff]/14",
    chip: "bg-[#3f0050] text-[#ffe3ff]",
    ...ARTICLE_SITE_COLORS.purple,
  },
  "Scenic Design": {
    icon: Drama,
    color: "text-[#1385f6]",
    bg: "bg-[#1385f6]/14",
    chip: "bg-[#1385f6] text-[#a8f4ff]",
    ...ARTICLE_SITE_COLORS.blue,
  },
  "Tools & Technology": {
    icon: Wrench,
    color: "text-[#35ad62]",
    bg: "bg-[#35ad62]/16",
    chip: "bg-[#35ad62] text-[#003f1c]",
    ...ARTICLE_SITE_COLORS.green,
  },
  "Performance History & Culture": {
    icon: BookOpen,
    color: "text-[#ff6f00]",
    bg: "bg-[#ff6f00]/14",
    chip: "bg-[#ff6f00] text-[#20180f]",
    ...ARTICLE_SITE_COLORS.orange,
  },
  "Profiles & Interviews": {
    icon: UserRound,
    color: "text-[#ff6f00]",
    bg: "bg-[#ff6f00]/14",
    chip: "bg-[#e9e1cf] text-[#20180f]",
    ...ARTICLE_SITE_COLORS.cream,
  },
  Rendering: {
    icon: Layers3,
    color: "text-[#1385f6]",
