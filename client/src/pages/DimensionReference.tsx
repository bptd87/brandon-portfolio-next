...
const DIMENSIONS: DimensionItem[] = [
  // EXPERIENTIAL - EXHIBITION
  { name: 'Standard Booth (10\'x10\')', category: 'Experiential - Exhibition', width: '10\'-0"', depth: '10\'-0"', height: '8\'-0"', notes: 'Standard inline booth space', wireframe: 'https://xibkuwouvisabnfowthn.supabase.co/storage/v1/object/public/portfolio/dimension-reference/MYh0xVxdYTMwUIq5kJ2YMF-img-1_1770588401000_na1fn_d2lyZWZyYW1lLWJvb3RoLTEweDEwLTE2eDk-6248c677a9.png' },
  { name: 'Standard Booth (10\'x20\')', category: 'Experiential - Exhibition', width: '20\'-0"', depth: '10\'-0"', height: '8\'-0"', notes: 'Double inline booth', wireframe: 'https://xibkuwouvisabnfowthn.supabase.co/storage/v1/object/public/portfolio/dimension-reference/MYh0xVxdYTMwUIq5kJ2YMF-img-2_1770588384000_na1fn_d2lyZWZyYW1lLWJvb3RoLTEweDIwLTE2eDk-d2f8bfc4f5.png' },
  ...
  // FURNITURE - SEATING
  { name: 'Standard Sofa (3-Seat)', category: 'Furniture - Seating', width: '84" - 96"', depth: '36" - 40"', height: '30" - 36"', notes: 'Common residential', wireframe: 'https://xibkuwouvisabnfowthn.supabase.co/storage/v1/object/public/portfolio/dimension-reference/MYh0xVxdYTMwUIq5kJ2YMF-img-3_1770588393000_na1fn_d2lyZWZyYW1lLXNvZmEtM3NlYXQtMTZ4OQ-9f23d8d583.png' },
  ...
  { name: 'Bar Stool (Standard)', category: 'Furniture - Seating', width: '16" - 18"', depth: '16" - 18"', height: '30"', wireframe: 'https://xibkuwouvisabnfowthn.supabase.co/storage/v1/object/public/portfolio/dimension-reference/MYh0xVxdYTMwUIq5kJ2YMF-img-5_1770588386000_na1fn_d2lyZWZyYW1lLWJhci1zdG9vbC0xNng5-8c885c518e.png' },
