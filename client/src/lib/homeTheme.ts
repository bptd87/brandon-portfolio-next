...
export const HOME_PAPER_BG = "#eee9df";
export const HOME_PAPER_INK = "#174d46";
export const HOME_PAPER_ACCENT = "#0b7a70";
...
export const HOME_COLOR_THEMES: HomeColorTheme[] = [
  {
    ...
    bg: HOME_PAPER_BG,
    ink: HOME_PAPER_INK,
    muted: "rgba(23,77,70,0.7)",
    ghost: "#6f817b",
    accent: HOME_PAPER_ACCENT,
    accentSoft: "rgba(11,122,112,0.12)",
    controlBg: "#d8d2c6",
    controlInk: HOME_PAPER_INK,
    footerBg: "#d8d2c6",
    footerDisplay: HOME_PAPER_ACCENT,
    footerInk: HOME_PAPER_INK,
  },
  {
    name: "Cream",
    bg: "#e9e1cf",
...
const HOME_CSS_THEME: HomeColorTheme = {
  name: "Stored",
  bg: "var(--home-theme-bg, #eee9df)",
  ink: "var(--home-theme-ink, #174d46)",
  muted: "var(--home-theme-muted, rgba(23,77,70,0.7))",
  ghost: "var(--home-theme-ghost, #6f817b)",
  accent: "var(--home-theme-accent, #0b7a70)",
  accentSoft: "var(--home-theme-accent-soft, rgba(11,122,112,0.12))",
  controlBg: "var(--home-theme-control-bg, #174d46)",
  controlInk: "var(--home-theme-control-ink, #f7f2e9)",
  footerBg: "var(--home-theme-footer-bg, #d8d2c6)",
  footerDisplay: "var(--home-theme-footer-display, #0b7a70)",
  footerInk: "var(--home-theme-footer-ink, #174d46)",
};

const HOME_THEME_STORAGE_KEY = "brandon-home-theme-index";
const HOME_THEME_VERSION_KEY = "brandon-home-theme-version";
const HOME_THEME_VERSION = "4";
