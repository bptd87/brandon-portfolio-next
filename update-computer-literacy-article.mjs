...
// Enhanced article content with images and proper formatting
const enhancedContent = [
  ...
  {
    type: 'heading',
    content: 'Bridging Generational Gaps in Computer Literacy'
  },
  {
    type: 'paragraph',
  ...
  },
  {
    ...
    alt: 'Student working on computer with code on screen',
    caption: 'Modern students need guidance navigating traditional desktop software interfaces'
  },
  {
    type: 'heading',
    content: 'A Curriculum Tailored to the Future'
  },
  {
    type: 'paragraph',
  ...
  {
    type: 'heading',
    content: 'Day 1: Unraveling Computer Hardware'
  },
  {
    type: 'list',
    listType: 'bullet',
  ...
  {
    type: 'quote',
    content: 'I\'ve found that quirky anecdotes help demystify complex ideas. For example, I compare the CPU to the brain and the RAM to a juggler balancing coursework. This session teaches students to assess their software and hardware needs for wise investments.'
  },
  {
    type: 'image',
    url: 'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?w=1200&q=80',
    alt: 'Computer hardware components laid out on desk',
    caption: 'Understanding hardware components empowers students to make informed purchasing decisions'
  },
  {
    type: 'heading',
    content: 'Day 2: Mastering File Management and Storage'
  },
  {
    type: 'list',
    listType: 'bullet',
  ...
  {
    type: 'quote',
    content: 'This session teaches key file management skills. It stresses the importance of teamwork and collaboration in production environments where multiple team members need access to the same files.'
  },
  {
    type: 'heading',
    content: 'Day 3: The Rise of Artificial Intelligence'
  },
  {
    type: 'list',
    listType: 'bullet',
  ...
  },
  {
    ...
    caption: 'Exploring AI tools opens new creative possibilities for theatre production students'
  },
  {
    type: 'heading',
    content: 'Empowering Students for the Future'
  },
  {
    type: 'paragraph',
...
const result = await db.update(schema.articles)
  ...
  .where(eq(schema.articles.slug, 'empowering-theatre-students-with-computer-literacy'));

console.log('✅ Article updated successfully!');
console.log('Enhanced with:');
console.log('- 3 inline images with captions');
console.log('- Proper section formatting');
console.log('- Pull quotes for key insights');
console.log('- No FAQ section');
console.log('- No drop cap formatting');
