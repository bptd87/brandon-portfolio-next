...
export const siteMetadata = {
  ...
  description:
    "San Diego-based union scenic designer creating story-driven stage environments, theatrical renderings, and production design work for regional theatre and live performance.",
};
